local function MyRoutine()
	...
	local function Standard()
		...
		if S.Judgment:IsReady() and Target:IsInMeleeRange(5) and Target:IsSpellInRange(S.Judgment) and (EnemiesCount8y > 3 and Player:BuffStack(S.BulwarkofRighteousFuryBuff) >= 3 and Player:HolyPower() < 3) then
		...
		if S.ArcaneTorrent:IsCastable() and Target:IsInRange(5) and (Player:HolyPower() < 5) then
