...
Action[ACTION_CONST_WARLOCK_AFFLI] = {
    ...
    BloodoftheEnemy                      = Action.Create({ Type = "Spell", ID = 297108, Hidden = true}),
    BloodoftheEnemy2                     = Action.Create({ Type = "Spell", ID = 298273, Hidden = true}),
    BloodoftheEnemy3                     = Action.Create({ Type = "Spell", ID = 298277, Hidden = true}),
    ConcentratedFlame                    = Action.Create({ Type = "Spell", ID = 295373, Hidden = true}),
    ConcentratedFlame2                   = Action.Create({ Type = "Spell", ID = 299349, Hidden = true}),
    ConcentratedFlame3                   = Action.Create({ Type = "Spell", ID = 299353, Hidden = true}),
    GuardianofAzeroth                    = Action.Create({ Type = "HeartOfAzeroth", ID = 295840, Hidden = true}),
    GuardianofAzeroth2                   = Action.Create({ Type = "HeartOfAzeroth", ID = 299355, Hidden = true}),
    GuardianofAzeroth3                   = Action.Create({ Type = "HeartOfAzeroth", ID = 295840, Hidden = true}),
    FocusedAzeriteBeam                   = Action.Create({ Type = "Spell", ID = 295258, Hidden = true}),
    FocusedAzeriteBeam2                  = Action.Create({ Type = "Spell", ID = 299336, Hidden = true}),
    FocusedAzeriteBeam3                  = Action.Create({ Type = "Spell", ID = 299338, Hidden = true}),
    PurifyingBlast                       = Action.Create({ Type = "Spell", ID = 295337, Hidden = true}),
    PurifyingBlast2                      = Action.Create({ Type = "Spell", ID = 299345, Hidden = true}),
    PurifyingBlast3                      = Action.Create({ Type = "Spell", ID = 299347, Hidden = true}),
    TheUnboundForce                      = Action.Create({ Type = "Spell", ID = 298452, Hidden = true}),
    TheUnboundForce2                     = Action.Create({ Type = "Spell", ID = 299376, Hidden = true}),
    TheUnboundForce3                     = Action.Create({ Type = "Spell", ID = 299378, Hidden = true}),
    RippleInSpace                        = Action.Create({ Type = "Spell", ID = 302731, Hidden = true}),
    RippleInSpace2                       = Action.Create({ Type = "Spell", ID = 302982, Hidden = true}),
    RippleInSpace3                       = Action.Create({ Type = "Spell", ID = 302983, Hidden = true}),
    WorldveinResonance                   = Action.Create({ Type = "Spell", ID = 295186, Hidden = true}),
    WorldveinResonance2                  = Action.Create({ Type = "Spell", ID = 298628, Hidden = true}),
    WorldveinResonance3                  = Action.Create({ Type = "Spell", ID = 299334, Hidden = true}),
    MemoryofLucidDreams                  = Action.Create({ Type = "Spell", ID = 298357, Hidden = true}),
    MemoryofLucidDreams2                 = Action.Create({ Type = "Spell", ID = 299372, Hidden = true}),
    MemoryofLucidDreams3                 = Action.Create({ Type = "Spell", ID = 299374, Hidden = true}),
