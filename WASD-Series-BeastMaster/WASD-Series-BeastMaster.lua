local function MyRoutine()
	local Author = 'WASD Series - Beast Master Hunter'
	...
	local function Cleave()
		...
		if S.KillCommand:IsReady() then
		  if CastTargetIf(S.KillCommand, Enemies40y, "max", EvaluateTargetIfFilterKillCommand, not Target:IsInRange(50)) then return "kill_command cleave 22"; end
		end
